...
namespace Benday.Presidents.MvcIntegrationTests
{
    ...
    public class PresidentEncodingFixture
    {
        ...
        public async Task GetAllPresidents_TermDoesNotHaveIsDeleted()
        {
            ...
            JArray bodyAsJArray = JArray.Parse(responseBody);

            Assert.AreNotEqual<int>(0, bodyAsJArray.Count, "bodyAsJArray should not be zero");

            var presidentAsJson = bodyAsJArray[0];
