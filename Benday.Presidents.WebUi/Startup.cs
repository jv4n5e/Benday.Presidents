...
namespace Benday.Presidents.WebUi
{
    public class Startup
    {
        ...
        private bool IsSubscriptionCheckEnabled(IServiceCollection services)
        {
            var tempServiceProvider = services.BuildServiceProvider();

            var featureMgr = tempServiceProvider.GetService<IFeatureManager>();

            return featureMgr.Subscriptions;
        }
        ...
        void RegisterTypes(IServiceCollection services)
        {
            ...
            if (IsSubscriptionCheckEnabled(services) == true)
            {
                services.AddTransient<IUserAuthorizationStrategy, DefaultUserAuthorizationStrategy>();
            }
            else
            {
                services.AddTransient<IUserAuthorizationStrategy, FreeSubscriptionsUserAuthorizationStrategy>();
            }
